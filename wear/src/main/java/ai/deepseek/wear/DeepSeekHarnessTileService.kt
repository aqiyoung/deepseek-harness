...
class DeepSeekHarnessTileService :
  ...
  override suspend fun MaterialScope.tileResponse(requestParams: RequestBuilders.TileRequest): TileBuilders.Tile {
    val talkAction = wearLaunchAction(this@DeepSeekHarnessTileService, WearLaunchTarget.Voice)
    val openAction = wearLaunchAction(this@DeepSeekHarnessTileService, WearLaunchTarget.Chat)
