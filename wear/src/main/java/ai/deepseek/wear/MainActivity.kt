  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      if (scene == null) {
        ...
        DeepSeekHarnessWearScreenshotApp(scene)
      }
    }
  }
...
@Composable
internal fun DeepSeekHarnessWearApp(
  ...
  DeepSeekHarnessWearTheme(themeMode = themeMode) {
    AppScaffold {
      DeepSeekHarnessWearScreens(
        snapshot = snapshot,
        failure = failure,
        ...
        onTalk = {
          if (!state.connected || snapshot?.activeSessionId == null) return@DeepSeekHarnessWearScreens
