...
class SessionKeyTest {
  ...
  fun buildAndroidAppSessionLabelIncludesDeviceDisplayName() {
    assertEquals("DeepSeekHarness App · 1234567890ab", buildAndroidAppSessionLabel(null, "1234567890abcdef"))
    assertEquals(
      "DeepSeekHarness App · Pixel · 1234567890ab",
  ...
  fun buildAndroidAppSessionLabelPreservesUtf16BoundariesAtDisplayNameLimit() {
    ...
    assertEquals(
      "DeepSeekHarness App · $splitPairPrefix · 1234567890ab",
      buildAndroidAppSessionLabel("$splitPairPrefix😀tail", deviceId),
    )

    val completePairPrefix = "a".repeat(94)
    assertEquals(
      "DeepSeekHarness App · $completePairPrefix😀 · 1234567890ab",
