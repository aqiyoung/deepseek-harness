...
class AccessibilityDevActivity : AppCompatActivity() {
  ...
  private fun refreshForegroundPackage() {
    foregroundPackageName = DeepSeekHarnessAccessibilityService.instance?.foregroundPackageName()
  }
...
private fun AccessibilityDevScreen(
  ...
  val serviceConnection by DeepSeekHarnessAccessibilityService.connection.collectAsState()
