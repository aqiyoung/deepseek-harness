...
import ai.deepseek.harness.accessibility.AccessibilityComponentController
  ...
  AlertDialog(
    ...
    text = {
      Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
        Text(
          nativeString(
            "Enabling lets DeepSeekHarness observe and control other apps' screens when armed. Android accessibility access is required.",
          ),
        )
      }
    },
