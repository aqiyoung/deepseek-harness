    ...
    function injectCss() {
      ...
      el.textContent = [
        ...
        ".dsh-mobile-active .VOzbGW_panel{",
          ...
          "max-width:100vw !important;left:0 !important;top:0 !important;border-radius:0 !important;",
        ...
        ".dsh-mobile-active .VOzbGW_nav{",
          ...
          "padding:20px 6px !important;box-sizing:border-box !important;",
          "border-right:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,0.15)) !important;",
          "flex-direction:column !important;align-items:center !important;",
          "gap:8px !important;display:flex !important;overflow-y:auto !important;",
        "}",
        ...
        ".dsh-mobile-active .VOzbGW_navCell{",
          "width:64px !important;height:48px !important;border-radius:14px !important;",
          "justify-content:center !important;align-items:center !important;",
          "gap:0 !important;padding:0 !important;",
          "flex-direction:column !important;display:flex !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_navIcon{width:24px !important;height:24px !important;flex:none !important;}",
        ".dsh-mobile-active .VOzbGW_navLabel{display:none !important;}",
        ...
        "}",
        ".dsh-mobile-active .VOzbGW_header{",
          "height:54px !important;padding:16px !important;",
          "justify-content:space-between !important;align-items:center !important;",
          "display:flex !important;gap:8px !important;flex:none !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_actions{display:flex !important;align-items:center !important;gap:8px !important;}",
        ".dsh-mobile-active .VOzbGW_close{width:32px !important;height:32px !important;}",
        ".dsh-mobile-active .VOzbGW_options{",
          "flex:1 !important;min-height:0 !important;",
          "padding:0 16px 24px 16px !important;overflow-y:auto !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_options [data-slot=\"settings.general.item\"]{",
          "display:flex !important;align-items:center !important;gap:12px !important;",
          "padding:12px 0 !important;min-height:44px !important;",
          "border-bottom:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,0.1)) !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_options [data-slot=\"settings.general.item\"]:last-child{border-bottom:none !important;}",
