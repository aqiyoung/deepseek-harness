    ...
    function injectCss() {
      ...
      el.textContent = [
        ...
        ".dsh-mobile-active .VOzbGW_nav{",
          ...
          "padding:2px 6px !important;box-sizing:border-box !important;",
        ...
        ".dsh-mobile-active .VOzbGW_navList{",
          "flex-direction:row !important;align-items:center !important;",
          "width:auto !important;height:auto !important;gap:4px !important;",
          "overflow-x:auto !important;overflow-y:hidden !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_navCell{",
          "white-space:nowrap !important;flex:0 0 auto !important;",
          "padding:6px 10px !important;height:32px !important;",
        "}",
        /* 内容列独占整行、可竖向滚动 */
        ".dsh-mobile-active .VOzbGW_content{",
          "flex:1 1 auto !important;width:100% !important;max-width:500px !important;margin:0 auto !important;min-width:0 !important;",
          "overflow-y:auto !important;overflow-x:hidden !important;padding:2px 0 !important;",
          "-webkit-overflow-scrolling:touch !important;",
        "}",
        /* body 行为 */
        ...
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItem]{",
          "padding:6px 16px !important;min-height:36px !important;",
        "}",
        ...
        ".dsh-mobile-active .VOzbGW_content [class*=settingsGroup]{",
          "padding:2px 0 !important;gap:2px !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsGroup] > *{",
        ...
        ".dsh-mobile-active .VOzbGW_content [class*=settingsSectionTitle]{",
          "padding:4px 16px 2px !important;font-size:12px !important;",
        "}",
        ...
        ".dsh-mobile-active .hHd-Xa_root:not(.hHd-Xa_collapsed) [class*=sectionHeader]{",
          ...
          "justify-content:space-between !important;align-items:center !important;padding:6px 10px !important;",
        "}",
