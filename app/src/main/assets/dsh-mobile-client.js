  ...
  factory: function(require) {
    ...
    function injectCss() {
      ...
      el.textContent = [
        ...
        /* ===== 设置弹窗（VOzbGW）手机适配：现代移动端设计 ===== */
        ".dsh-mobile-active .VOzbGW_overlay{padding:0 !important;background:rgba(0,0,0,0.5) !important;}",
        ...
        ".dsh-mobile-active .VOzbGW_nav{",
          ...
          "border-bottom:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,0.2)) !important;",
          "gap:8px !important;",
        "}",
        ...
        ".dsh-mobile-active .VOzbGW_navList{",
          "flex-direction:row !important;align-items:center !important;",
          "width:auto !important;height:auto !important;gap:8px !important;",
          "overflow-x:auto !important;overflow-y:hidden !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_navCell{",
          "white-space:nowrap !important;flex:0 0 auto !important;",
          "padding:8px 16px !important;height:40px !important;",
          "border-radius:8px !important;font-size:14px !important;",
        "}",
        /* 内容区全宽、竖向滚动 */
        ".dsh-mobile-active .VOzbGW_content{",
          "flex:1 1 auto !important;width:100% !important;max-width:none !important;min-width:0 !important;",
          "overflow-y:auto !important;overflow-x:hidden !important;",
          "padding:16px 0 24px !important;",
          "-webkit-overflow-scrolling:touch !important;",
        "}",
        "body.dsh-mobile-active{font-size:15px !important;}",
        /* 设置项：标准移动行高 44px，图标+标签+值布局 */
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItem]{",
          "display:flex !important;align-items:center !important;gap:12px !important;",
          "padding:12px 20px !important;min-height:44px !important;",
          "border-radius:0 !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingRow]{",
          "display:flex !important;align-items:center !important;gap:12px !important;",
          "padding:12px 20px !important;min-height:44px !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsRow]{",
          "display:flex !important;align-items:center !important;gap:12px !important;",
          "padding:12px 20px !important;min-height:44px !important;",
        "}",
        /* 设置图标：24px 固定，flex-shrink 不压缩 */
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItemIcon]{",
          "width:24px !important;height:24px !important;flex-shrink:0 !important;",
          "display:flex !important;align-items:center !important;justify-content:center !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItemIcon] svg{",
          "width:20px !important;height:20px !important;display:block !important;",
        "}",
        /* 设置标签：14px，弹性伸展，不溢出 */
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItemLabel]{",
          "font-size:14px !important;flex:1 1 auto !important;min-width:0 !important;",
          "color:var(--dsw-alias-label-primary,#111) !important;",
          "white-space:nowrap !important;overflow:hidden !important;text-overflow:ellipsis !important;",
        "}",
        /* 设置值：14px，靠右，弱化色 */
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItemValue]{",
          "font-size:14px !important;flex-shrink:0 !important;",
          "color:var(--dsw-alias-label-secondary,#666) !important;",
          "white-space:nowrap !important;",
        "}",
        /* 分组/区块：标题样式 + 内边距 */
        ".dsh-mobile-active .VOzbGW_content [class*=settingsSection]{",
          "padding:0 !important;margin-bottom:16px !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsGroup]{",
          "padding:0 !important;gap:1px !important;",
          "border:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,0.15)) !important;",
          "border-radius:12px !important;overflow:hidden !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsGroup] > *{",
          "padding:12px 20px !important;border-radius:0 !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsSectionTitle]{",
          "padding:12px 20px 6px !important;font-size:13px !important;font-weight:600 !important;",
          "text-transform:uppercase !important;letter-spacing:0.05em !important;",
          "color:var(--dsw-alias-label-tertiary,#888) !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsDivider]{",
          "height:1px !important;margin:0 !important;",
          "background:var(--dsw-alias-border-l2,rgba(127,127,127,0.15)) !important;",
        "}",
        ".dsh-mobile-active .VOzbGW_content [class*=settingsItem]:not([class*=settingsGroup])",
          ":not(:last-child){",
          "border-bottom:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,0.1)) !important;",
        "}",
    ...
    function applyDrawerStyles(sb) {
      ...
      if (regionInner) regionInner.style.cssText = "width:100% !important;display:flex !important;justify-content:space-between !important;align-items:center !important;padding:6px 10px !important;";
