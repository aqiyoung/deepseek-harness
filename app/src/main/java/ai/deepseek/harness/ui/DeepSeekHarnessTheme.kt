...
fun DeepSeekHarnessTheme(
  ...
  DeepSeekHarnessSystemBarAppearance(lightAppearance = !isDark)
...
@Composable
internal fun DeepSeekHarnessSystemBarAppearance(lightAppearance: Boolean) {
