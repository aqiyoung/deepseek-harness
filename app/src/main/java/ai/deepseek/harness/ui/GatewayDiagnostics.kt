...
import ai.deepseek.harness.gatewayConnectionStatusForDisplay
...
internal fun buildGatewayDiagnosticsReport(
  ...
  return nativeString(
    "Help diagnose this DeepSeekHarness Android gateway connection failure.\n\n" +
      "Please:\n" +
...
internal fun copyGatewayDiagnosticsReport(
  ...
  clipboard.setPrimaryClip(ClipData.newPlainText("DeepSeekHarness gateway diagnostics", report))
