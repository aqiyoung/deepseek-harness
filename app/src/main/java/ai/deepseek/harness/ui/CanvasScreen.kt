...
import ai.deepseek.harness.node.CanvasNavigationPolicy
...
internal class CanvasHostView(
  ...
  private fun createWebView(): WebView =
    WebView(context).also { webView ->
      ...
      if (isDebuggable) {
        Log.d("DeepSeekHarnessWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("DeepSeekHarnessWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("DeepSeekHarnessWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("DeepSeekHarnessWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
      addView(
        webView,
