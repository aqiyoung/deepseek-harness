...
import ai.deepseek.harness.GatewayDevicePairingCapabilities
import ai.deepseek.harness.GatewayDevicePairingMutation
import ai.deepseek.harness.GatewayDeviceTokenSummary
...
import ai.deepseek.harness.GatewayPairedDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "DeepSeekHarness $it" }
