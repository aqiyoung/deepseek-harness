...
internal const val actionOpenConversationNotification =
  "ai.deepseek.harness.action.OPEN_CONVERSATION_NOTIFICATION"
internal const val actionConsumeConversationNotification =
  "ai.deepseek.harness.action.CONSUME_CONVERSATION_NOTIFICATION"
internal const val actionReplyConversationNotification =
  "ai.deepseek.harness.action.REPLY_CONVERSATION_NOTIFICATION"

private const val extraGatewayStableId = "ai.deepseek.harness.extra.CONVERSATION_GATEWAY_ID"
private const val extraAgentId = "ai.deepseek.harness.extra.CONVERSATION_AGENT_ID"
private const val extraSessionKey = "ai.deepseek.harness.extra.CONVERSATION_SESSION_KEY"
private const val extraRunId = "ai.deepseek.harness.extra.CONVERSATION_RUN_ID"
private const val extraLaunchToken = "ai.deepseek.harness.extra.CONVERSATION_LAUNCH_TOKEN"
private const val remoteInputReply = "ai.deepseek.harness.remote_input.CONVERSATION_REPLY"
private const val notificationIntentScheme = "dsh"
...
private const val conversationChannelId = "dsh.chat.replies"
private const val conversationNotificationId = 1
private const val conversationNotificationTagPrefix = "dsh.chat."
private const val conversationShortcutPrefix = "dsh-chat-"
private const val conversationGroup = "dsh.chat"
...
internal class ConversationReplyNotifier(
  ...
  private fun replyAction(target: ConversationNotificationTarget): NotificationCompat.Action {
    ...
    val remoteInput =
      RemoteInput
        ...
        .setLabel(nativeString("Reply to DeepSeekHarness…"))
        .build()
  ...
  private fun ensureConversationShortcut(target: ConversationNotificationTarget) {
    val shortcut =
      ShortcutInfoCompat
        ...
        .setShortLabel(nativeString("DeepSeekHarness"))
        .setLongLived(true)
  ...
  private fun assistantPerson(): Person =
    Person
      .Builder()
      .setName(nativeString("DeepSeekHarness"))
      .setBot(true)
      .build()
