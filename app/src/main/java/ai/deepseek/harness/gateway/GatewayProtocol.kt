...
enum class GatewayMethod(
  ...
  DshChat("dsh.chat"),
  DshChatHistory("dsh.chat.history"),
  DshChangesList("dsh.changes.list"),
  DshApprovalList("dsh.approval.list"),
  DshSetupDetect("dsh.setup.detect"),
  DshSetupActivate("dsh.setup.activate"),
  DshSetupAuthStart("dsh.setup.auth.start"),
  DshSetupPrepareStart("dsh.setup.prepare.start"),
  ...
  DshSetupVerify("dsh.setup.verify"),
...
enum class GatewayEvent(
  ...
  DshApprovalRequested("dsh.approval.requested"),
  DshApprovalResolved("dsh.approval.resolved"),
