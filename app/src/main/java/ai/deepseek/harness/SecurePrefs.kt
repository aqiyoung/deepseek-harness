...
import ai.deepseek.harness.gateway.GatewayCustomHeaders
import ai.deepseek.harness.gateway.GatewayRegistryStore
import ai.deepseek.harness.gateway.GatewayStoreMigration
...
class SecurePrefs(
  ...
  internal fun getNotificationForwardingPolicy(appPackageName: String): NotificationForwardingPolicy {
    ...
    // Always block DeepSeekHarness's own notifications in blocklist mode to prevent forwarding loops.
